...
| PNF biologists (if able) | Lower Marble Creek (n=2) | \~11 km upstream of the MFSR confluence. |
| PNF biologists (if able) | Upper Beaver Creek | Otherwise Bryan covers this himself. |
...
- \~20.5 km upstream (\~45.130°N, -114.951°W, volcanic rock meets valley-fill deposits)
...
- If your trip reaches down to about 15 km upstream of the Big Creek confluence (\~45.066°N, -115.116°W), that's the one spot where the bedrock shifts to a metasedimentary unit and a second sample there would be valuable — but only if it's on your route already, not worth a special trip.
...
- \~40 km upstream (\~44.546°N, -114.856°W, the far edge of sedimentary patch)
...
- \~4.6 km upstream on main trunk, below where East and West Forks join (\~44.540°N, -114.802°W)
- **West Fork Mayfield Creek**, upstream of contact (\~44.505°N, -114.744°W)
- On **East Fork Mayfield Creek**, near contact if possible (\~44.551°N, -114.745°W)

![](../img/site_maps/MAY.png)

{{< pagebreak >}}

**Camas Creek** (if you get to it):

- \~3.5 km upstream of `CAM-010`, down from Yellowjacket Creek confluence (\~44.890°N, -114.678°W)
